...
var resizePizzas = function(size) {
  ...
  function determineDx (elem, size) {
    ...
    function sizeSwitcher (size) {
      switch(size) {
        case "1":
          return 25; // it's been changed from .25 to 25 to be absolute percentages.
        case "2":
          return 33.33; // it's been changed from 0.3333 to 33.33 to be absolute percentages.
        case "3":
          return 50; // it's been changed from 0.5 to 50 to be absolute percentages.
        default:
